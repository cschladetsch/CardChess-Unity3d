namespace UIWidgets
{
	...
	public class ColorPickerRangeHSV : MonoBehaviour, IStylable
	{
		...
		protected virtual void UpdateViewReal()
		{
			...
			{
				sliderBackground.material.SetColor("_ColorLeft", ColorLeft.ShaderColor);
				sliderBackground.material.SetColor("_ColorRight", ColorRight.ShaderColor);
			}
			else
			{
				sliderBackground.material.SetColor("_ColorBottom", ColorLeft.ShaderColor);
				sliderBackground.material.SetColor("_ColorTop", ColorRight.ShaderColor);
			}
