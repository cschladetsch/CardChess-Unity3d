namespace UIWidgets.Examples
{
	...
	public class ComboboxChanges : MonoBehaviour
	{
		...
		void HideList()
		{
			...
			Debug.Log("Selected indices: " + string.Join(", ", new_selected.Select(x => x.ToString()).ToArray()));
			Debug.Log("New selected indices: " + string.Join(", ", added.Select(x => x.ToString()).ToArray()));
			Debug.Log("Unselected indices: " + string.Join(", ", removed.Select(x => x.ToString()).ToArray()));
		}
