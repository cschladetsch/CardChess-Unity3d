...
namespace App
{
    ...
    public class ArbiterGameObject : MonoBehaviour
    {
        public void Awake()
        {
            ...
            //var m0 = a.NewModel<Player, EColor>(EColor.White);
            //var m1 = a.NewModel<Player, EColor>(EColor.Black);
            //var p0 = a.NewAgent<PlayerAgent, IPlayerModel>(m0);
            //var p1 = a.NewAgent<PlayerAgent, IPlayerModel>(m1);
            //var d0 = a.NewModel<Deck, Guid, IPlayerModel>(Guid.Empty, m0);
            //var d1 = a.NewModel<Deck, Guid, IPlayerModel>(Guid.Empty, m1);
