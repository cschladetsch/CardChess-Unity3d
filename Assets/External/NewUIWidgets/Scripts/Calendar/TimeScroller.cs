	...
	public class TimeScroller : TimeBase
	{
		...
		protected override void InitInput()
		{
			if (HoursScrollBlock != null)
			{
				...
				HoursScrollBlock.Decrease = () => Time = LoopedHours(-1);
				HoursScrollBlock.Increase = () => Time = LoopedHours(+1);
			...
			if (MinutesScrollBlock != null)
			{
				...
				MinutesScrollBlock.Decrease = () => Time = LoopedMinutes(-1);
				MinutesScrollBlock.Increase = () => Time = LoopedMinutes(+1);
			...
			if (SecondsScrollBlock != null)
			{
				...
				SecondsScrollBlock.Decrease = () => Time = LoopedSeconds(-1);
				SecondsScrollBlock.Increase = () => Time = LoopedSeconds(+1);
			...
			if (AMPMScrollBlock != null)
			{
				...
				AMPMScrollBlock.Decrease = () => Time = LoopedHours(-1, 12);
				AMPMScrollBlock.Increase = () => Time = LoopedHours(+1, 12);
