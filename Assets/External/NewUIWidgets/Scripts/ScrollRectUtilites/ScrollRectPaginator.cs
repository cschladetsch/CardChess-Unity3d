...
#pragma warning restore 0649
		...
		protected virtual void Init()
		{
			...
			var dragListener = Utilites.GetOrAddComponent<DragListener>(ScrollRect);
		...
		protected virtual int GetPage()
		{
			...
			return Mathf.RoundToInt(position / GetPageSize());
		}
		...
		/// <summary>
		/// Upgrade serialized data to latest version.
		/// </summary>
