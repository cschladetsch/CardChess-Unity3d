	...
	public class FileListViewPath : MonoBehaviour, IStylable
	{
		...
		public virtual bool SetStyle(Style style)
		{
			if (Template != null)
			{
				...
				Template.ForEachCache(x => x.SetStyle(style.FileListView.PathItemBackground, style.FileListView.PathItemText, style));
			}

			Components.ForEach(x => x.SetStyle(style.FileListView.PathItemBackground, style.FileListView.PathItemText, style));
